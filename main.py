...
canvas = Canvas(win, width=window_width, height=window_height)
canvas.pack()
...
def redraw_screen():
    car1_y, car1_x, car2_y, car2_x, \
        obstacle_x, obstacle_y, boost_x, boost_y, \
        game_over_message =\
...
def start():
    ...
    message.place(y=450, x=800, width=500)
